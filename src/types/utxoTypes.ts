...
interface IUtxoStatisticsBip9 {                  // numeric statistics about BIP9 signalling for a softfork (only for started status)
...
interface IUtxoBip9 {                          // status of bip9 softforks (only for bip9 type)
...
interface IUtxoSoftFork { // name of the softfork
