...
describe("Global settings tests ", () => {
    ...
    it("set callbacks", () => {
        function loggingCallback(message: string): void { console.log(message); }
        function warningCallback(message: string): void { console.warn(message); }
        function errorCallback(message: string): void { console.error(message); }
